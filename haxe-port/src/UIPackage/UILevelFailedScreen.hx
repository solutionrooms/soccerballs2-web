...
class UILevelFailedScreen extends UIScreenInstance
{
    ...
    override public function InitScreen()
    {
        ...
        Lic.AnimatedMCMoreGamesButton(titleMC.btn_moregames, "levelfailed");
        ...
        titleMC.levelComplete.btn_continue.visible = false;
        
        TextStrings.ReplaceTextFieldText(titleMC.levelComplete.title, "level failed");
